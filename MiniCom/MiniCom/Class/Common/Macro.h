...
#ifndef LittleWeather_Macro_h
#define LittleWeather_Macro_h
...
#define DefaultBadImageName @"defaultimage.jpg"
...
#define ContentType_Voice @"voice"

#define NetChangeNotification @"hadNetNotification"

#define UserinfoChangedNotification @"UserinfoChangedNotification"

#define SquareEvent_MessageNotification @"SquareEvent_MessageNotification"

#define SessionEvent_Group @"SessionEvent_GroupNotification"
#define SessionEvent_Own @"SessionEvent_OwnNotification"

#define SessionEvent_MessageNotification @"SessionEvent_MessageNotification"
...
#define H_division_W   (float)kScreen_Height / (float)kScreen_Width
#define W_division_H   (float)kScreen_Width  / (float)kScreen_Height
...
//message
#define CheckUserName_Null      @"手机号不能为空"
#define CheckUserName_NoHave    @"手机号不存在"
#define CheckUserName_Fail      @"手机号码格式错误"

#define CheckPassword_Null      @"密码不能为空"
#define CheckPassword_Fail      @"密码长度应为6至18位"


#define CheckCode_Null          @"验证码不能为空"
